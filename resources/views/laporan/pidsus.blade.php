...
@section('title', 'Laporan Bidang Pidsus')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Laporan Bidang Pidsus</h4>

                        <form action="{{ route('laporan.pidsus') }}" method="GET">
                            <div class="row mb-3">
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <a href="{{ route('laporan.exportPdfPidsus', ['bulan' => $bulan, 'tahun' => $tahun]) }}"
