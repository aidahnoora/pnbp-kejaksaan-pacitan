...
@section('title', 'Laporan Bidang BB')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Laporan Bidang BB</h4>

                        <form action="{{ route('laporan.bb') }}" method="GET">
                            <div class="row mb-3">
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <a href="{{ route('laporan.exportPdfBb', ['bulan' => $bulan, 'tahun' => $tahun]) }}"
